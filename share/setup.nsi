...
!define URL http://www.zapphire.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/zapphire.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\zapphire-qt.exe
...
OutFile zapphire-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/zapphire-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/zapphired.exe
    ...
    #Delete /REBOOTOK $INSTDIR\zapphire.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\zapphire-qt.exe
